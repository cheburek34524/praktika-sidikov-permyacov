...
function SubjectsPanel({ subjects, groups, teachers, onChange }) {
  ...
  return (
    <section>
      ...
      <div style={{
        ...
        border: "1px solid #e6eaf3", borderRadius: 6, padding: 6, marginBottom: 6
      }}>
      ...
      <div className="row">
        <button className="primary" onClick={add}>+ Добавить дисциплину</button>
      </div>
...
window.SubjectsPanel = SubjectsPanel;